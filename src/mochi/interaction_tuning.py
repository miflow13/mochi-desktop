...
# Full intensity is deliberately reachable at 600 px/s for a responsive feel.
DRAG_SOFT_ENTER_THRESHOLD = 0.10
DRAG_MEDIUM_ENTER_THRESHOLD = 0.22
...
HOVER_HEART_COOLDOWN_SECONDS = 1.5
